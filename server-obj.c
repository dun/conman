/*****************************************************************************\
 *  $Id: server-obj.c,v 1.76 2003/08/02 00:02:18 dun Exp $
 *****************************************************************************
 ...
 */
    ...
    if (strchr(name, '%'))
        logfile->aux.logfile.fmtName = str_create(name);
    else
 ...
 */
    ...
    if (serial->fd >= 0) {
        tty_set_mode(serial->fd, &serial->aux.serial.tty);
